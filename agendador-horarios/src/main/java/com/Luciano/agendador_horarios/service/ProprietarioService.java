...
public class ProprietarioService {
    ...
    public List<Proprietario> buscarProprietario(
        ...
        List<Proprietario> proprietarios =
                proprietarioRepository.
                        findByIdProprietarioAndNomeAndEmail
                                (
    ...
    @PreAuthorize("hasRole('PROPRIETARIO')")
    public Proprietario alterarNome(
            String nomeAtual,
            String novoNome
    ) {
        Proprietario proprietarioExistente =
                proprietarioRepository.
                findByNome(nomeAtual);
