...
public class ClienteService {
    ...
    public Cliente salvarCliente(Cliente cliente) {
        ...
        Cliente clienteExistente =
                clienteRepository.
                        findByNomeClienteAndTelefoneCliente(
    ...
    @PreAuthorize("hasRole('PROPRIETARIO')")
    public Cliente alterarNomeCliente
            (
            String atualNomeCliente,
    ...
    @PreAuthorize("hasRole('PROPRIETARIO')")
    public Cliente alterarTelefoneCliente(
            String telefoneAtual,
            String TelefoneNovo
    ) {
        Cliente clienteComTelefone =
                clienteRepository.
                        findByTelefoneCliente
                                (telefoneAtual);
