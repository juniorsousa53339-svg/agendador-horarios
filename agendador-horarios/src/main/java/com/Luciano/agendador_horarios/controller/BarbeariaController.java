...
public class BarbeariaController {
    ...
    @GetMapping
    public ResponseEntity<List<Barbearia>> buscarBarbearia(@RequestParam String nomeBarbearia) {
        return ResponseEntity.ok().body(barbeariaService.buscarBarbearia(nomeBarbearia));
    }

    @PutMapping
    public ResponseEntity<Barbearia> alterarBarbearia(@RequestBody Barbearia barbearia,
                                                      @RequestParam String nomeBarbearia,
                                                      @RequestParam String rua,
                                                      @RequestParam int numeroRua) {
        return ResponseEntity.accepted().body(barbeariaService.alterarBarbearia(
                barbearia,
                nomeBarbearia,
                rua,
                numeroRua
